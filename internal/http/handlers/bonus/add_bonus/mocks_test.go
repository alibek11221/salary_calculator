...
import (
	context "context"
	reflect "reflect"
	add_bonus "salary_calculator/internal/dto/add_bonus"
...
func (m *Mockusecase) Do(ctx context.Context, in add_bonus.In) (*add_bonus.Out, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Do", ctx, in)
	ret0, _ := ret[0].(*add_bonus.Out)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
