...
// Package delete_s_change_test is a generated GoMock package.
package delete_s_change_test
...
func (m *Mockusecase) Do(ctx context.Context, in delete_salary_change.In) (*delete_salary_change.Out, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Do", ctx, in)
	ret0, _ := ret[0].(*delete_salary_change.Out)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
