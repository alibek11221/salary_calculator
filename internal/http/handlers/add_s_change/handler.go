...
import (
	...
	uc "salary_calculator/internal/usecase/salary_change/add"
)
...
// @Accept       json
// @Produce      json
// @Param        input body add_salary_change.In true "Данные изменения"
// @Success      200  {object}  add_salary_change.Out
// @Failure      400  {object}  map[string]string "error"
// @Failure      500  {object}  map[string]string "error"
// @Router       /salary/changes/ [post]
func (h Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	var req add_salary_change.In
	...
	if err != nil {
		if errors.Is(err, uc.ErrDuplicateSalaryChange) {
