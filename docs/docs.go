...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "salary_calculator_internal_services_calculator.PayoutBreakdown": {
            "type": "object",
            "properties": {
                "advance": {
                    "type": "number"
        ...
        "salary_calculator_internal_services_calculator.SalaryCalculationResult": {
            ...
            "properties": {
                "brutto": {
                    "description": "Brutto — оклад грязными, без доплат.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/salary_calculator_internal_services_calculator.PayoutBreakdown"
                        }
                    ]
                },
                "extra_payments": {
                ...
                "in_hand": {
                    "description": "InHand — фактические выплаты на руки: netto + доплаты своего типа,\nTotal дополнительно включает выплаты типа extra (премия, отпускные).",
                    "allOf": [
                        {
                            "$ref": "#/definitions/salary_calculator_internal_services_calculator.PayoutBreakdown"
                        }
                ...
                "netto": {
                    "description": "Netto — оклад за вычетом НДФЛ, без доплат.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/salary_calculator_internal_services_calculator.PayoutBreakdown"
                        }
